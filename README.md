...
However, the most critical responsibility of an engineering manager is the continuous growth of their team through continuous mentorship, and aligning projects with team member's individual career goals.  Engineering managers handle the people, the psychology, and the architecture allowing the business to scale efficiently.  
...
### 1. Load Balancing
Ensure the Team Lead has well-defined acceptance criteria, and is properly delegating tasks, and actively pairing juniors with seniors to prevent burnout while increasing knowledge transfer.  
...
A new manager should never walk into a a successful business and immediately start making opinionated changes.  Even if technical debt is obvious and operational friction exists, the EM is lacking the required context to act.  The EMs initial job is not to intervene, but to listen, observe, and map the system.
